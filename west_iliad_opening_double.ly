...
\header {
  ...
  subtitle = "Iliad I, 1-5 (doubled note values)"
  composer = "M. L. West"
  tagline = \markup {
    \center-column {
      ...
      "Note values doubled for readability"
    }
  }
}
...
intro = {
  \clef "treble_8"
  \time 7/8
  c'4. a4 a4 | b4. c'2 | e'4. c'4 c'4 | b4. c'4 b4 |
...
lineOne = {
  ...
  b4. b4 b4 |
  c'8.\([ b8.]\) a4. r8 |
  \grace { c'16( b16 } a4.) \grace { c'16( b16 } a4) c'4 |
}
...
lineThree = {
  ...
  b4. b4 c'4 |
  a4. a4. r8 |
  \acciaccatura { b8( } a4.) \grace { c'16 b16 } a4 c'4 |
}
